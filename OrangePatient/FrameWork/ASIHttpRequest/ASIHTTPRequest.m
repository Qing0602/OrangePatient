...
- (void)reportFinished
{
    if ([self respondsToSelector:@selector(customLogic)]) {
        [self performSelector:@selector(customLogic)];
    }
    ...
    if ([self respondsToSelector:@selector(customLogicAfterCallBack)]) {
        [self performSelector:@selector(customLogicAfterCallBack)];
    }
}
...
//	return ([[Reachability reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN);	
    return ([[Reachability reachabilityForInternetConnection] currentReachabilityStatus] == ReachableVia3G || [[Reachability reachabilityForInternetConnection] currentReachabilityStatus] == ReachableVia2G);
}
